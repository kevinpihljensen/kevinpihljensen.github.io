...
// QUAKE FLOOR — light tan concrete with grime. Earlier version was reading
// too dark / muddy (warm brown 0.72 blue-down + base 44-92). Lightened so
// it sits between qstone (cool grey) and qmetal (rust): warm sandstone
// concrete that still reads as "floor" but doesn't pull the scene dark.
export function makeQuakeFloorTexture() {
  ...
  // 2×2 panel grooves — slightly softer.
